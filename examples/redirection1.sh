...
echo "Redirect output on a file. (Error is redirected in /dev/null)"
echo "With command: find . -name file3.txt > file_out.txt"
echo
find . -name file3.txt > file_out.txt > /dev/null
echo
echo
...
echo "Redirect error on a file. Outpit is redirected in /dev/null)"
echo "With command: find . -name file3.txt 2> file_err.txt"
echo 
find . -name file3.txt 2> file_err.txt > /dev/null
echo
echo
